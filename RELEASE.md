...
Pushing the tag triggers the `Build and Push` [GitHub workflow](https://github.com/Kuadrant/kuadrant-console-plugin/blob/release-0.3/.github/workflows/build-push.yaml), which:
