...
const useTokenRateLimitPolicyActions = (obj: K8sResourceCommon): ExtensionHookResult<Action[]> => {
  ...
  const actions = React.useMemo<Action[]>(() => {
    ...
    const updateAccess: AccessReviewResourceAttributes | undefined = tokenRateLimitPolicyModel
      ? {
          group: tokenRateLimitPolicyModel.apiGroup,
          resource: tokenRateLimitPolicyModel.plural,
          verb: 'update',
          name,
          namespace,
        }
      : undefined;
    const deleteAccess: AccessReviewResourceAttributes | undefined = tokenRateLimitPolicyModel
      ? {
          group: tokenRateLimitPolicyModel.apiGroup,
          resource: tokenRateLimitPolicyModel.plural,
          verb: 'delete',
