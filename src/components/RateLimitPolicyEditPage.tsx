        ...
        <ErrorBoundary fallback={yamlViewNode}>
          <PageSection hasBodyWrapper={false}>
            <Form className="co-m-pane__form">
              ...
              <FormGroup label={t('Limit Rate')} isRequired fieldId="limit-rate">
                <TextInput
                  isRequired
                  type="number"
                  id="limit-rate"
              ...
              <FormGroup label={t('Window')} isRequired fieldId="limit-window">
                <TextInput
                  isRequired
                  type="text"
                  id="limit-window"
                  name="limit-window"
                  value={window}
                  onChange={(_event, value) => setWindow(value)}
                />
              </FormGroup>
